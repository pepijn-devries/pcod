...
cat('Number of animals predicted to experience significant disturbance on one day of piling for each operation', daily_NDt, file = zz, "\n")
cat('Number of animals predicted to experience PTS on one day of piling', daily_NPt, file = zz, "\n")
